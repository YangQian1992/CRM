# -*- coding: utf-8 -*-
# Generated by Django 1.11.14 on 2018-09-05 16:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='old_boy_crm.ClassList', verbose_name='班级')),
            ],
        ),
        migrations.CreateModel(
            name='ConsultRecord',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, to='old_boy_crm.ClassList', verbose_name='已报班级')),
                ('customer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='old_boy_crm.Customer', verbose_name='客户信息')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classstudyrecord', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='old_boy_crm.ClassStudyRecord', verbose_name='第几天课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='old_boy_crm.Student', verbose_name='学员')),
            ],
        ),
        migrations.CreateModel(
            name='UserInfo',
            fields=[
                ...
                ('depart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='old_boy_crm.Department', to_field='code', verbose_name='部门')),
        ...
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consultanter', to='old_boy_crm.UserInfo', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='customer',
            name='course',
            field=models.ManyToManyField(to='old_boy_crm.Course', verbose_name='咨询课程'),
        ),
        migrations.AddField(
            model_name='customer',
            name='referral_from',
            field=models.ForeignKey(blank=True, help_text='若此客户是转介绍自内部学员,请在此处选择内部学员姓名', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='internal_referral', to='old_boy_crm.Customer', verbose_name='转介绍自学员'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='old_boy_crm.UserInfo', verbose_name='跟踪人'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='old_boy_crm.Customer', verbose_name='所咨询客户'),
        ),
        migrations.AddField(
            model_name='classstudyrecord',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='old_boy_crm.UserInfo', verbose_name='讲师'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='old_boy_crm.Course', verbose_name='课程名称'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='old_boy_crm.School', verbose_name='校区'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(to='old_boy_crm.UserInfo', verbose_name='任课老师'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='tutor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_list', to='old_boy_crm.UserInfo', verbose_name='班主任'),
        ),
    ]

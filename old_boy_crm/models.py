...
class ClassList(models.Model):
    ...
    teachers = models.ManyToManyField(verbose_name='任课老师', to='UserInfo',limit_choices_to={"depart_id__in":[1004,1005]})
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name="class_list",limit_choices_to={"depart_id":1003})
...
class ClassStudyRecord(models.Model):
    ...
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo', limit_choices_to={"depart_id__in": [1004, 1005]})
